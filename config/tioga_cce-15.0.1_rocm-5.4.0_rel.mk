...
WORK = /p/lustre1/vicmagri
PROJECTS = $(HOME)/projects
MFEM_CONFIG = cce-$(COMPILER_VERSION)_rocm-$(ROCM_VERSION)_rel
PREFIX = $(WORK)/projects/forks/mfem-dev/install/$(MFEM_CONFIG)
...
HYPRE_CONFIG = cce-$(COMPILER_VERSION)_rocm-$(ROCM_VERSION)_rel
HYPRE_DIR = /p/lustre1/vicmagri/projects/hypre-amd/$(HYPRE_CONFIG)
