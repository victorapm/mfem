...
DEBUG_FLAGS = -O0 -g $(XCOMPILER)-Wall $(BASE_FLAGS)
...
PREFIX = $(PROJECTS)/mfem-vm/install/gcc11_rel
...
HYPRE_DIR = $(PROJECTS)/hypre-mfem/src/hypre
...
ifeq ($(MFEM_USE_SUPERLU)$(MFEM_USE_STRUMPACK)$(MFEM_USE_MUMPS),NONONO)
   ifeq ($(MFEM_USE_METIS_5),NO)
     ...
     METIS_DIR = $(PROJECTS)/metis-5.1.0/install/release
